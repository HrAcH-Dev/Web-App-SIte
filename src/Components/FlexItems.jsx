...
export default function FlexItems() {
  return (
    <Container>
        <div className='col-span-full w-full flex justify-evenly gap-[71px] items-center'>
        {DESIGN_ITEM.map(elem => {
            return (
                <div className='rounded-[20px] bg-[#fff]/[0.1] border-[3px] border-[#EE0BD7] relative mt-[72px] mb-[72px] flex justify-center gap-[1] items-center flex-wrap w-[255px] text-white h-[255px]' key={elem.id}>
