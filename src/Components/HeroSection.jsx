    ...
    <Container>
        <div className="col-span-full text-white flex justify-start relative">
            <div className='w-[70%] mt-[97px]'>
                ...
                <button className='tex-[30px] font-medium leading-[36px] bg-gradient-to-r from-purple-500 to-pink-500 py-[21px] px-[33px] mt-[59px] rounded-[40px]'>Kickstart my game</button>
            </div>
            <div className='w-[59%] absolute -top-[4%] -right-[9%]'>
