  ...
  return (
    <Container>
        <div className='mb-[250px] col-span-full flex justify-center border-[7px] bg-[#fff]/[0.1] border-[#EE0BD7] rounded-[38px]'>
            <div className='text-white  lg:w-[53%] pt-[113px] pl-[10px] lg:pl-[62px]'>
            ...
            <div className='w-[40%] lg:w-[47%] pl-[130px] mt-[98px] relative'>
                <img src={join} alt="join" className='absolute right-[1%] lg:static ' />
                <div className={`w-[300px] h-[300px] rounded-full blur-[126px] -z-10 absolute right-[14%] top-[1%] 2xl:right-[-33%] 2xl:top-[-23%] ${styles.filter}`} />
            </div>
        </div>
    </Container>
  )
